...
Hello the following is a python script that can be used to solve the following prompt. There are some base case tests that test the functionality at a high level.

# FDE Technical Screen

1. In the main.py file please reference the code.
2. Copy the code from the main.py file
3. Paste the code in your favorite python compiler and run it
4. You will see the test cases run with the following expected answer. /Note- comments were made to help facilitate expected outcome. 
